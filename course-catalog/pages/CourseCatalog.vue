...
<template>
    <div id="courses" class="flex justify-center items-start h-screen w-full px-12 bg-green-100">
        <div id="content" class="flex flex-col justify-center items-start w-full mt-24 space-y-6 bg-blue-100">
