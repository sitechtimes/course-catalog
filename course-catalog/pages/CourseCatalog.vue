    ...
    <div id="courses" class="flex justify-center items-start h-screen px-12">
        ...
        <div id="content" class="w-full mt-24 space-y-6">
            ...
            <div id="search" class="w-full flex justify-start items-center space-x-4">
                <select name="sort" id="sort" class="w-40 h-10 p-1 border border-zinc-300 rounded">
                    <option>Sort by</option>
                    <option value="name">Course Name</option>
                    <option value="subject">Subject</option>
                    <option value="grade">Grade</option>
                </select>
                <input type="text" placeholder="Search" class="border border-zinc-300 rounded w-112 h-10 p-2">
            </div>
        </div>
    </div>
</template>
