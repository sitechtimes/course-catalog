...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.0581cf3d.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500.858f4714.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component.5834e878.mjs.map
