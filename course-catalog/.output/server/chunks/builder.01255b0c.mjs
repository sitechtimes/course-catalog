...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "whole" }, _attrs))}><div class="requirements"><button class="note"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zm0-384c13.3 0 24 10.7 24 24V264c0 13.3-10.7 24-24 24s-24-10.7-24-24V152c0-13.3 10.7-24 24-24zm32 224c0 17.7-14.3 32-32 32s-32-14.3-32-32s14.3-32 32-32s32 14.3 32 32z"></path></svg></button>`);
  if ($data.showr) {
    _push(`<div class="require"><div class="uncr"><h3 class="mt-0 font-bold">Requirements (different for seniors)</h3>`);
    _push(ssrRenderComponent(_component_bl, null, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          if (this.needed.ENGLISH === 0) {
            _push2(`<li${_scopeId}><svg class="x" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"${_scopeId}><path d="M175 175C184.4 165.7 199.6 165.7 208.1 175L255.1 222.1L303 175C312.4 165.7 327.6 165.7 336.1 175C346.3 184.4 346.3 199.6 336.1 208.1L289.9 255.1L336.1 303C346.3 312.4 346.3 327.6 336.1 336.1C327.6 346.3 312.4 346.3 303 336.1L255.1 289.9L208.1 336.1C199.6 346.3 184.4 346.3 175 336.1C165.7 327.6 165.7 312.4 175 303L222.1 255.1L175 208.1C165.7 199.6 165.7 184.4 175 175V175zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"${_scopeId}></path></svg> English </li>`);
          } else {
            _push2(`<!---->`);
          }
          if (this.needed.ENGLISH !== 0) {
            _push2(`<li${_scopeId}><svg class="check" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"${_scopeId}><path d="M243.8 339.8C232.9 350.7 215.1 350.7 204.2 339.8L140.2 275.8C129.3 264.9 129.3 247.1 140.2 236.2C151.1 225.3 168.9 225.3 179.8 236.2L224 280.4L332.2 172.2C343.1 161.3 360.9 161.3 371.8 172.2C382.7 183.1 382.7 200.9 371.8 211.8L243.8 339.8zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"${_scopeId}></path></svg> English </li>`);
          } else {
            _push2(`<!---->`);
          }
          if (this.needed.MATH === 0) {
            _push2(`<li${_scopeId}><svg class="x" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"${_scopeId}><path d="M175 175C184.4 165.7 199.6 165.7 208.1 175L255.1 222.1L303 175C312.4 165.7 327.6 165.7 336.1 175C346.3 184.4 346.3 199.6 336.1 208.1L289.9 255.1L336.1 303C346.3 312.4 346.3 327.6 336.1 336.1C327.6 346.3 312.4 346.3 303 336.1L255.1 289.9L208.1 336.1C199.6 346.3 184.4 346.3 175 336.1C165.7 327.6 165.7 312.4 175 303L222.1 255.1L175 208.1C165.7 199.6 165.7 184.4 175 175V175zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"${_scopeId}></path></svg> Math </li>`);
          } else {
            _push2(`<!---->`);
          }
          if (this.needed.MATH !== 0) {
          ...
          if (this.needed.SS === 0) {
            _push2(`<li${_scopeId}><svg class="x" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"${_scopeId}><path d="M175 175C184.4 165.7 199.6 165.7 208.1 175L255.1 222.1L303 175C312.4 165.7 327.6 165.7 336.1 175C346.3 184.4 346.3 199.6 336.1 208.1L289.9 255.1L336.1 303C346.3 312.4 346.3 327.6 336.1 336.1C327.6 346.3 312.4 346.3 303 336.1L255.1 289.9L208.1 336.1C199.6 346.3 184.4 346.3 175 336.1C165.7 327.6 165.7 312.4 175 303L222.1 255.1L175 208.1C165.7 199.6 165.7 184.4 175 175V175zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"${_scopeId}></path></svg>History </li>`);
          } else {
            _push2(`<!---->`);
          }
          if (this.needed.SS !== 0) {
          ...
          if (this.needed.PE === 0) {
            _push2(`<li${_scopeId}><svg class="x" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"${_scopeId}><path d="M175 175C184.4 165.7 199.6 165.7 208.1 175L255.1 222.1L303 175C312.4 165.7 327.6 165.7 336.1 175C346.3 184.4 346.3 199.6 336.1 208.1L289.9 255.1L336.1 303C346.3 312.4 346.3 327.6 336.1 336.1C327.6 346.3 312.4 346.3 303 336.1L255.1 289.9L208.1 336.1C199.6 346.3 184.4 346.3 175 336.1C165.7 327.6 165.7 312.4 175 303L222.1 255.1L175 208.1C165.7 199.6 165.7 184.4 175 175V175zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"${_scopeId}></path></svg> Gym </li>`);
          } else {
            _push2(`<!---->`);
          }
          if (this.needed.PE !== 0) {
          ...
          if (this.yearPicked !== `Senior` && this.needed.SCIENCE === 0) {
            _push2(`<li${_scopeId}><svg class="x" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"${_scopeId}><path d="M175 175C184.4 165.7 199.6 165.7 208.1 175L255.1 222.1L303 175C312.4 165.7 327.6 165.7 336.1 175C346.3 184.4 346.3 199.6 336.1 208.1L289.9 255.1L336.1 303C346.3 312.4 346.3 327.6 336.1 336.1C327.6 346.3 312.4 346.3 303 336.1L255.1 289.9L208.1 336.1C199.6 346.3 184.4 346.3 175 336.1C165.7 327.6 165.7 312.4 175 303L222.1 255.1L175 208.1C165.7 199.6 165.7 184.4 175 175V175zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"${_scopeId}></path></svg> Science </li>`);
          } else {
            _push2(`<!---->`);
          }
          if (this.yearPicked !== `Senior` && this.needed.SCIENCE !== 0) {
          ...
          if (this.yearPicked !== `Senior` && this.needed.LANG === 0) {
            _push2(`<li${_scopeId}><svg class="x" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"${_scopeId}><path d="M175 175C184.4 165.7 199.6 165.7 208.1 175L255.1 222.1L303 175C312.4 165.7 327.6 165.7 336.1 175C346.3 184.4 346.3 199.6 336.1 208.1L289.9 255.1L336.1 303C346.3 312.4 346.3 327.6 336.1 336.1C327.6 346.3 312.4 346.3 303 336.1L255.1 289.9L208.1 336.1C199.6 346.3 184.4 346.3 175 336.1C165.7 327.6 165.7 312.4 175 303L222.1 255.1L175 208.1C165.7 199.6 165.7 184.4 175 175V175zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"${_scopeId}></path></svg> Russian </li>`);
          } else {
            _push2(`<!---->`);
          }
          if (this.yearPicked !== `Senior` && this.needed.LANG !== 0) {
          ...
          if (this.yearPicked !== `Senior` && this.needed.LUNCH !== 0) {
            _push2(`<li${_scopeId}><svg class="x" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"${_scopeId}><path d="M175 175C184.4 165.7 199.6 165.7 208.1 175L255.1 222.1L303 175C312.4 165.7 327.6 165.7 336.1 175C346.3 184.4 346.3 199.6 336.1 208.1L289.9 255.1L336.1 303C346.3 312.4 346.3 327.6 336.1 336.1C327.6 346.3 312.4 346.3 303 336.1L255.1 289.9L208.1 336.1C199.6 346.3 184.4 346.3 175 336.1C165.7 327.6 165.7 312.4 175 303L222.1 255.1L175 208.1C165.7 199.6 165.7 184.4 175 175V175zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"${_scopeId}></path></svg> Lunch </li>`);
          } else {
            _push2(`<!---->`);
          }
          if (this.yearPicked !== `Senior` && this.needed.LUNCH === 0) {
          ...
          if (this.needed.educationalPeriods < 7) {
            _push2(`<li${_scopeId}><svg class="x" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"${_scopeId}><path d="M175 175C184.4 165.7 199.6 165.7 208.1 175L255.1 222.1L303 175C312.4 165.7 327.6 165.7 336.1 175C346.3 184.4 346.3 199.6 336.1 208.1L289.9 255.1L336.1 303C346.3 312.4 346.3 327.6 336.1 336.1C327.6 346.3 312.4 346.3 303 336.1L255.1 289.9L208.1 336.1C199.6 346.3 184.4 346.3 175 336.1C165.7 327.6 165.7 312.4 175 303L222.1 255.1L175 208.1C165.7 199.6 165.7 184.4 175 175V175zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"${_scopeId}></path></svg>7 educational periods (not including lunch) </li>`);
          } else {
            _push2(`<!---->`);
          }
          if (this.needed.educationalPeriods >= 7) {
  ...
  _push(`</div><div class="tabs"><button class="tab r">Russian</button><button class="tab g">Gym</button><button class="tab a">Art</button><button class="tab t"> Technology </button><button class="tab h">History</button><button class="tab en">English</button><button class="tab s">Science</button><button class="tab m">Math</button></div><div class="folder">`);
  if ($data.showSubjects.showrussian) {
    _push(`<div class="file LANG"><div class="holders"><!--[-->`);
    ssrRenderList($data.courses.filter(
      (course) => course.catalog && course.subject === `LANG` && course[`${this.yearPicked.toLowerCase()}`]
    ), (course) => {
      _push(`<div class="placeholder LANG"><h4>${ssrInterpolate(course.name)}</h4></div>`);
    });
    _push(`<!--]--></div></div>`);
  } else {
    _push(`<!---->`);
  ...
  if ($data.showSubjects.showgym) {
    _push(`<div class="file PE"><div class="holders"><!--[-->`);
    ssrRenderList($data.courses.filter(
      (course) => course.catalog && course.subject === `PE` && course[`${this.yearPicked.toLowerCase()}`]
    ), (course) => {
      _push(`<div class="placeholder PE"><h4>${ssrInterpolate(course.name)}</h4></div>`);
    });
    _push(`<!--]--></div></div>`);
  } else {
    _push(`<!---->`);
  ...
  if ($data.showSubjects.showart) {
    _push(`<div class="file a"><div class="holders"><!--[-->`);
    ssrRenderList($data.courses.filter(
      (course) => course.catalog && course.subject === `ARTS` && course[`${this.yearPicked.toLowerCase()}`]
    ), (course) => {
      _push(`<div class="placeholder ARTS"><h4>${ssrInterpolate(course.name)}</h4></div>`);
    });
    _push(`<!--]--></div></div>`);
  } else {
    _push(`<!---->`);
  ...
  if ($data.showSubjects.showtechnology) {
    _push(`<div class="file TECH"><div class="holders"><!--[-->`);
    ssrRenderList($data.courses.filter(
      (course) => course.catalog && course.subject === `TECH` && course[`${this.yearPicked.toLowerCase()}`]
    ), (course) => {
      _push(`<div class="placeholder TECH"><h4>${ssrInterpolate(course.name)}</h4></div>`);
    });
    _push(`<!--]--><!--[-->`);
    ssrRenderList($data.courses.filter(
  ...
  if ($data.showSubjects.showhistory) {
    _push(`<div class="file SS"><div class="holders"><!--[-->`);
    ssrRenderList($data.courses.filter(
      (course) => course.catalog && course.subject === `SS` && course[`${this.yearPicked.toLowerCase()}`]
    ), (course) => {
      _push(`<div class="placeholder SS"><h4>${ssrInterpolate(course.name)}</h4></div>`);
    });
    _push(`<!--]--></div></div>`);
  } else {
    _push(`<!---->`);
  ...
  if ($data.showSubjects.showenglish) {
    _push(`<div class="file ENGLISH"><div class="holders"><!--[-->`);
    ssrRenderList($data.courses.filter(
      (course) => course.catalog && course.subject === `ENGLISH` && course[`${this.yearPicked.toLowerCase()}`]
    ), (course) => {
      _push(`<div class="placeholder ENGLISH"><h4>${ssrInterpolate(course.name)}</h4></div>`);
    });
    _push(`<!--]--></div></div>`);
  } else {
    _push(`<!---->`);
  ...
  if ($data.showSubjects.showscience) {
    _push(`<div class="file SCIENCE"><div class="holders"><!--[-->`);
    ssrRenderList($data.courses.filter(
      (course) => course.catalog && course.subject === `SCIENCE` && course[`${this.yearPicked.toLowerCase()}`] && course.name !== `Comp Sci/Engineering T1`
    ), (course) => {
      _push(`<div class="placeholder SCIENCE"><h4>${ssrInterpolate(course.name)}</h4></div>`);
    });
    _push(`<!--]--></div></div>`);
  } else {
    _push(`<!---->`);
  ...
  if ($data.showSubjects.showmath) {
    _push(`<div class="file MATH"><div class="holders"><!--[-->`);
    ssrRenderList($data.courses.filter(
      (course) => course.catalog && course.subject === `MATH` && course[`${this.yearPicked.toLowerCase()}`]
    ), (course) => {
      _push(`<div class="placeholder MATH"><h4>${ssrInterpolate(course.name)}</h4></div>`);
    });
    _push(`<!--]--></div></div>`);
  } else {
    _push(`<!---->`);
  ...
  if ($data.showSubjects.showlanding) {
    _push(`<div class="file landing"><div class="content"><h2>Instructions</h2><h3> Click on subject tabs and drag desired courses to the schedule maker. Please keep in mind that this may not be your actual schedule that year. </h3></div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div></div>`);
...
const Courses = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$1 = {
  name: "Scheduler",
  props: {
    schedule: [Object],
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<table${ssrRenderAttrs(mergeProps({ class: "whole" }, _attrs))} data-v-a112acfe><tr class="" data-v-a112acfe><th class="p-4 py-2" id="right" data-v-a112acfe>Period</th><th class="px-20" data-v-a112acfe>Class</th></tr><tr class="border-t-4" data-v-a112acfe><td class="right" id="" data-v-a112acfe>1</td><td data-v-a112acfe><div class="${ssrRenderClass([$props.schedule[0].subject, "placeholder"])}" id="first" data-v-a112acfe>${ssrInterpolate($props.schedule[0].name)}</div></td></tr><tr class="" data-v-a112acfe><td class="right" id="" data-v-a112acfe>2</td><td data-v-a112acfe><div class="${ssrRenderClass([$props.schedule[1].subject, "placeholder"])}" data-v-a112acfe>${ssrInterpolate($props.schedule[1].name)}</div></td></tr><tr class="" data-v-a112acfe><td class="right" id="" data-v-a112acfe>3</td><td data-v-a112acfe><div class="${ssrRenderClass([$props.schedule[2].subject, "placeholder"])}" data-v-a112acfe>${ssrInterpolate($props.schedule[2].name)}</div></td></tr><tr class="" data-v-a112acfe><td class="right" id="" data-v-a112acfe>4</td><td data-v-a112acfe><div class="${ssrRenderClass([$props.schedule[3].subject, "placeholder"])}" data-v-a112acfe>${ssrInterpolate($props.schedule[3].name)}</div></td></tr><tr class="" data-v-a112acfe><td class="right" id="" data-v-a112acfe>5</td><td data-v-a112acfe><div class="${ssrRenderClass([$props.schedule[4].subject, "placeholder"])}" data-v-a112acfe>${ssrInterpolate($props.schedule[4].name)}</div></td></tr><tr class="" data-v-a112acfe><td class="right" id="" data-v-a112acfe>6</td><td data-v-a112acfe><div class="${ssrRenderClass([$props.schedule[5].subject, "placeholder"])}" data-v-a112acfe>${ssrInterpolate($props.schedule[5].name)}</div></td></tr><tr class="" data-v-a112acfe><td class="right" id="" data-v-a112acfe>7</td><td data-v-a112acfe><div class="${ssrRenderClass([$props.schedule[6].subject, "placeholder"])}" data-v-a112acfe>${ssrInterpolate($props.schedule[6].name)}</div></td></tr><tr class="" data-v-a112acfe><td class="right" id="" data-v-a112acfe>8</td><td data-v-a112acfe><div class="${ssrRenderClass([$props.schedule[7].subject, "placeholder"])}" data-v-a112acfe>${ssrInterpolate($props.schedule[7].name)}</div></td></tr><tr class="" data-v-a112acfe><td class="right" id="lastnum" data-v-a112acfe>9</td><td data-v-a112acfe><div class="${ssrRenderClass([$props.schedule[8].subject, "placeholder"])}" id="last" data-v-a112acfe>${ssrInterpolate($props.schedule[8].name)}</div></td></tr></table>`);
}
...
const Scheduler = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-a112acfe"]]);
const _sfc_main = {
...
//# sourceMappingURL=builder.01255b0c.mjs.map
