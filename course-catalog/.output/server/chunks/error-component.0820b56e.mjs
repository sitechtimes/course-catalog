...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.a561570e.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500.80346f25.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component.0820b56e.mjs.map
