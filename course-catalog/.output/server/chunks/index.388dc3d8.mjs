...
import { _ as _sfc_main$6, a as _sfc_main$7 } from './CourseType.abc53bf9.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import 'ufo';
      ...
      if (((_a = __props.course) == null ? void 0 : _a.catalog) == true) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              _push2(`<div id="card" class="bg-white w-80 h-36 m-4 px-4 py-[0.6rem] rounded-lg shadow cursor-pointer"${_scopeId}><h2 id="name" class="course-name text-2xl font-semibold h-[4.4rem]"${_scopeId}>${ssrInterpolate((_a2 = __props.course) == null ? void 0 : _a2.name)}</h2><div id="grade" class="flex justify-start items-start space-x-1 text-sm text-zinc-500"${_scopeId}><p class="font-medium pr-1"${_scopeId}>Grade</p><p class="font-bold space-x-1"${_scopeId}>`);
              if (((_b2 = __props.course) == null ? void 0 : _b2.freshman) == true) {
                _push2(`<span${_scopeId}>9 </span>`);
              } else {
                _push2(`<!---->`);
              }
              if (((_c = __props.course) == null ? void 0 : _c.sophomore) == true) {
                _push2(`<span${_scopeId}>10 </span>`);
              } else {
                _push2(`<!---->`);
              }
              if (((_d = __props.course) == null ? void 0 : _d.junior) == true) {
                _push2(`<span${_scopeId}>11 </span>`);
              } else {
                _push2(`<!---->`);
              }
              if (((_e = __props.course) == null ? void 0 : _e.senior) == true) {
                _push2(`<span${_scopeId}>12 </span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</p></div><div class="flex justify-start items-start space-x-2"${_scopeId}>`);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-40" data-v-5522afb3><a class="flex justify-left mt-2 ml-3" data-v-5522afb3><p class="font-bold" id="sortshow" data-v-5522afb3>${ssrInterpolate(selected.value)}</p></a></div>`);
      if (isOpen.value) {
        _push(`<div class="sub-menu" data-v-5522afb3><div class="flex justify-left h-10 p-1 border border-zinc-300 bg-white text-zinc-400" data-v-5522afb3><button class="ml-2" data-v-5522afb3>${ssrInterpolate(subject.value)}</button></div><div class="flex justify-left h-10 p-1 border border-t-transparent border-zinc-300 bg-white text-zinc-400" data-v-5522afb3><button class="ml-2" data-v-5522afb3>${ssrInterpolate(atoz.value)}</button></div><div class="flex justify-left h-10 p-1 border border-t-transparent border-zinc-300 bg-white text-zinc-400" data-v-5522afb3><button class="ml-2" data-v-5522afb3>${ssrInterpolate(ztoa.value)}</button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const SortComponent = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-5522afb3"]]);
const _sfc_main$2 = {};
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))}><div id="search-bar" class="flex justify-center items-center relative"><input${ssrRenderAttr("value", $props.modelValue)} placeholder="Search" class="border border-zinc-300 rounded w-112 h-10 p-2 text-zinc-800">`);
  _push(ssrRenderComponent(_component_SearchButton, { class: "absolute right-3 text-zinc-400 cursor-pointer" }, null, _parent));
  _push(`</div></div>`);
}
...
const SearchBar = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main = {
  components: {
    SearchBar,
    SortComponent,
    CourseCard: _sfc_main$5
  },
  data() {
    return {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_CourseCard = _sfc_main$5;
  _push(`<div${ssrRenderAttrs(mergeProps({
    id: "catalog",
    class: "flex justify-center items-start h-screen w-full px-12"
  }, _attrs))}><div id="content" class="flex flex-col justify-center items-center w-full mt-28 space-y-6"><h2 class="text-center text-4xl font-semibold">Courses</h2><div id="search" class="w-full flex flex-col justify-center items-center"><div id="search-section" class="flex justify-center items-center">`);
  ...
  _push(`</div><div id="courses" class="flex flex-wrap justify-center items-center max-w-[80rem]"><!--[-->`);
  ...
  if ($data.input && !$options.filteredList.length) {
    _push(`<div class="item error"><p>No results found!</p></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div></div></div>`);
...
//# sourceMappingURL=index.388dc3d8.mjs.map
