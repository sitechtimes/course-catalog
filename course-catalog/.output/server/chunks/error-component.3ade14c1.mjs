...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.94965c47.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500.937e6933.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component.3ade14c1.mjs.map
